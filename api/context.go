...
// Enforce  decides whether the user can access a "object" with the operation "action".
// func (c *Context) Enforce(pid string, object string, resOwner string, act string) (bool, error) {
// 	if len(c.UserName) == 0 {
// 		return false, nil
// 	}
// 	if c.enforcer == nil {
// 		var err error
// 		c.enforcer, err = permission.BuildEnforcer(c.UserName)
// 		if err != nil {
// 			return false, err
// 		}
// 	}
// 	return c.enforcer.Enforce(c.UserName, pid, object, resOwner, act)
// }
...
// NewRouterGroup create RouterGroup
func NewRouterGroup(routerGroup *gin.RouterGroup) *RouterGroup {
	return &RouterGroup{
